...
$(function () {
  ...
  $demoSettings.append(
    ...
    + 'Layout Fixo'
    + '</label>'
    + '<p>Ativa o layout fixo. Você não pode usar layout fixo e box ao mesmo tempo</p>'
    + '</div>'
    // Boxed layout
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    ...
    + 'Layout Box'
    + '</label>'
    + '<p>Ativa o layout box</p>'
    + '</div>'
    // Sidebar Toggle
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    + '<input type="checkbox"data-layout="sidebar-collapse"class="pull-right"/> '
    + 'Alterar Barra Esquerda'
    + '</label>'
    + '<p>Alterar o estado da barra lateral esquerda (expandido ou reduzido)</p>'
    + '</div>'
    ...
    + '</label>'
    + '<p>Expande barra lateral quando passar mouse</p>'
    + '</div>'
    // Control Sidebar Toggle
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    + '<input type="checkbox"data-controlsidebar="control-sidebar-open"class="pull-right"/> '
    + 'Alterar Barra Direita'
    + '</label>'
    + '<p>Alterar para reajustar conteúdo da página ao abrir menu lateral</p>'
    + '</div>'
    // Control Sidebar Skin Toggle
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    + '<input type="checkbox"data-sidebarskin="toggle"class="pull-right"/> '
    + 'Alterar tema menu direita'
    + '</label>'
    + '<p>Alterar dentre dark e light o tema para barra lateral direita</p>'
    + '</div>'
  )
