...
<html>
    ...
    <body>
        <div class="not-last-page" data-role="page" data-theme="a" id="page_7">
            <form name="formulario" id="formulario" action="<?= base_url('uploads/save') ?>" method="post" enctype="multipart/form-data" data-ajax="false">
                <?php
                // Cabeçalho é fixo
                include("header.php");
                ?>
                <div data-role="content" data-theme="a">
                    ...
                    <div class="ui-grid-a">
                        <div class="ui-block-a">
                            <a class="ui-btn" href="<?= base_url('uploads/limpar') ?>">LIMPAR PASTA</a>
                        </div>
                        <div class="ui-block-b">
                            <input type="submit" value="EFETUAR UPLOAD">
                        </div>
                    </div><!-- /grid-a -->
                </div>
            </form>
            <h3>Conteúdo da pasta teste</h3>
            <ul>
                <?php
                if(is_array($files)){
